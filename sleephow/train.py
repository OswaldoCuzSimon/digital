...
# Read input data
data = pickle.load(open(input('ruta del archivo de datos (sleepdata.pkl): ') or 'sleepdata.pkl', 'rb'))
...
print('Entrenamiento completo. Precision de: {0:.2f}% @epoch {1}'.format(
    peaks[0] * 100.0,
    peaks[1]) )

print ('El menor error fue {0:.2f} @epoch {1}'.format(
    peaks[2],
    peaks[3]))
